...
<c:url var="signupAction" value="./login/check" ></c:url> 
        ...
        <div class="col-md-6 col-md-offset-3">
            <form:form id="signupForm" action="${signupAction}" method="post" class="form" role="form" modelAttribute="user">   
              ...
              <span class="help-block" style="margin-left:100px;">
				<c:if test="${!empty userCheckResult}">
					${userCheckResult} 
				</c:if>
				</span>
                    <button class="btn btn-lg btn-primary btn-block signup-btn" type="submit">Login Into My Account</button>
            </form:form>          
</div> </div> </div> </div>  
